...
Bounce component from zurto-ui.

## Preview

<CodeToggle code="import { ZBounce } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZBounce>&#10;      Content here&#10;    </ZBounce>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">Bounce Component</div>
  </div>
</CodeToggle>
...
```tsx
<ZBounce size="sm">Small</ZBounce>
<ZBounce size="md">Medium</ZBounce>
<ZBounce size="lg">Large</ZBounce>
```
