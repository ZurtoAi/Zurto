...
TimePicker component from zurto-ui.

## Preview

<CodeToggle code="import { ZTimePicker } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZTimePicker>&#10;      Content here&#10;    </ZTimePicker>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">TimePicker Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZTimePicker } from 'zurto-ui';
```
...
```tsx
<ZTimePicker size="sm">Small</ZTimePicker>
<ZTimePicker size="md">Medium</ZTimePicker>
<ZTimePicker size="lg">Large</ZTimePicker>
```
