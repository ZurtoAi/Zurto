...
ScrollArea component from zurto-ui.

## Preview

<CodeToggle code="import { ZScrollArea } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZScrollArea>&#10;      Content here&#10;    </ZScrollArea>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">ScrollArea Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZScrollArea } from 'zurto-ui';
```
...
```tsx
<ZScrollArea size="sm">Small</ZScrollArea>
<ZScrollArea size="md">Medium</ZScrollArea>
<ZScrollArea size="lg">Large</ZScrollArea>
```
