...
ActionIcon component from zurto-ui.

## Preview

<CodeToggle code="import { ZActionIcon } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZActionIcon>&#10;      Content here&#10;    </ZActionIcon>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">ActionIcon Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZActionIcon } from 'zurto-ui';
```
...
```tsx
<ZActionIcon size="sm">Small</ZActionIcon>
<ZActionIcon size="md">Medium</ZActionIcon>
<ZActionIcon size="lg">Large</ZActionIcon>
```
