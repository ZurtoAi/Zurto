...
ShareButton component from zurto-ui.

## Preview

<CodeToggle code="import { ZShareButton } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZShareButton>&#10;      Content here&#10;    </ZShareButton>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">ShareButton Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZShareButton } from 'zurto-ui';
```
...
```tsx
<ZShareButton size="sm">Small</ZShareButton>
<ZShareButton size="md">Medium</ZShareButton>
<ZShareButton size="lg">Large</ZShareButton>
```
