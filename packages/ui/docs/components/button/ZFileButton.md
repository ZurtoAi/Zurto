...
FileButton component from zurto-ui.

## Preview

<CodeToggle code="import { ZFileButton } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZFileButton>&#10;      Content here&#10;    </ZFileButton>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">FileButton Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZFileButton } from 'zurto-ui';
```
...
```tsx
<ZFileButton size="sm">Small</ZFileButton>
<ZFileButton size="md">Medium</ZFileButton>
<ZFileButton size="lg">Large</ZFileButton>
```
