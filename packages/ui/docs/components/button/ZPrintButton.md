...
PrintButton component from zurto-ui.

## Preview

<CodeToggle code="import { ZPrintButton } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZPrintButton>&#10;      Content here&#10;    </ZPrintButton>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">PrintButton Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZPrintButton } from 'zurto-ui';
```
...
```tsx
<ZPrintButton size="sm">Small</ZPrintButton>
<ZPrintButton size="md">Medium</ZPrintButton>
<ZPrintButton size="lg">Large</ZPrintButton>
```
