...
FullscreenButton component from zurto-ui.

## Preview

<CodeToggle code="import { ZFullscreenButton } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZFullscreenButton>&#10;      Content here&#10;    </ZFullscreenButton>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">FullscreenButton Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZFullscreenButton } from 'zurto-ui';
```
...
```tsx
<ZFullscreenButton size="sm">Small</ZFullscreenButton>
<ZFullscreenButton size="md">Medium</ZFullscreenButton>
<ZFullscreenButton size="lg">Large</ZFullscreenButton>
```
