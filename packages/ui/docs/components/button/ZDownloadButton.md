...
DownloadButton component from zurto-ui.

## Preview

<CodeToggle code="import { ZDownloadButton } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZDownloadButton>&#10;      Content here&#10;    </ZDownloadButton>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">DownloadButton Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZDownloadButton } from 'zurto-ui';
```
...
```tsx
<ZDownloadButton size="sm">Small</ZDownloadButton>
<ZDownloadButton size="md">Medium</ZDownloadButton>
<ZDownloadButton size="lg">Large</ZDownloadButton>
```
