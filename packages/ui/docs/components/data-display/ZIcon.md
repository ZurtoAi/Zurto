...
Icon component from zurto-ui.

## Preview

<CodeToggle code="import { ZIcon } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZIcon>&#10;      Content here&#10;    </ZIcon>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">Icon Component</div>
  </div>
</CodeToggle>
...
```tsx
<ZIcon size="sm">Small</ZIcon>
<ZIcon size="md">Medium</ZIcon>
<ZIcon size="lg">Large</ZIcon>
```
