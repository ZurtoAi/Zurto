...
Collapse component from zurto-ui.

## Preview

<CodeToggle code="import { ZCollapse } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZCollapse>&#10;      Content here&#10;    </ZCollapse>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">Collapse Component</div>
  </div>
</CodeToggle>
...
```typescript
import { ZCollapse } from 'zurto-ui';
```
...
```tsx
<ZCollapse size="sm">Small</ZCollapse>
<ZCollapse size="md">Medium</ZCollapse>
<ZCollapse size="lg">Large</ZCollapse>
```
