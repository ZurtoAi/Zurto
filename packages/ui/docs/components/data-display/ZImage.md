...
<CodeToggle code="import { ZImage } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZImage>&#10;      Content here&#10;    </ZImage>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">Image Component</div>
  </div>
</CodeToggle>
