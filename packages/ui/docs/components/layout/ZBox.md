...
Box component from zurto-ui.

## Preview

<CodeToggle code="import { ZBox } from 'zurto-ui';&#10;&#10;function Example() {&#10;  return (&#10;    <ZBox>&#10;      Content here&#10;    </ZBox>&#10;  );&#10;}">
  <div style="display: flex; justify-content: center; align-items: center; min-height: 80px; padding: 24px;">
    <div style="padding: 20px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; color: #aaa; text-align: center;">Box Component</div>
  </div>
</CodeToggle>
...
```tsx
<ZBox size="sm">Small</ZBox>
<ZBox size="md">Medium</ZBox>
<ZBox size="lg">Large</ZBox>
```
